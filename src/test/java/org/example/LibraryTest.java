...
class LibraryTest {
    ...
    {
        lib = new Library();
        book1 = new Book("Whispers of the Forgotten","Cassandra Black");
        book2 = new Book("Serpents of the Celestial Realm","Evelyn Moonwater");
        dvd = new DVD("Napoleon",157);
        patron = new Patron ("Vitya");
